...
export const STAFF_EMAILS = {
  kitesurfing: process.env.STAFF_EMAIL_KITESURFING || 'audriusb88@gmail.com',
  dayUse: process.env.STAFF_EMAIL_DAY_USE || 'audriusb88@gmail.com',
  restaurant: process.env.STAFF_EMAIL_RESTAURANT || 'audriusb88@gmail.com',
};
