...
async function DayUseBookingsPage() {
  const result = await getBookingsByService("day-use");
  ...
  return (
    <div className="p-6">
      ...
      {sorted.length === 0 ? (
        <p className="text-muted-foreground">No day use bookings found.</p>
      ) : (
...
export default DayUseBookingsPage;
